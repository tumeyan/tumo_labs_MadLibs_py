...
def madlib2():
    ...
    print(f'''
          This weekend I am going camping with {Proper_Noun} {Person_Name}. I packed my lantern, sleeping bag, and 
          {Noun}. I am so {Adjective_Feeling} to {Verb} in a tent. I am {Adjective_Feeling_2} we might see a(n) 
          {Animal}, I hear they’re kind of dangerous. While we’re camping, we are going to hike, fish, and {Verb2}. 
          I have heard that the {Color} lake is great for {Verb_ing}. Then we will {Adverb_ly} hike through the 
          forest for {Number} {Measure_of_Time}. If I see a {Color} {Animal} while hiking, I am going
          to bring it home as a pet! At night we will tell {Number} {Silly_Word} stories and roast {Noun2} around the
          campfire!!''')
...
def madlib3():
    ...
    print(f'''
        ...
        {Magical_Creature_plural} and {Adjective3} {Magical_Creature_Plural2} here! In the  {Room_house} there is
